...
public class MinimumNumberOfPages {
	...
	// is feasible or not.
	boolean isPossible(int arr[], int n, int m, long curr_min)
	{
	...
	long findPages(int arr[], int n, int m)
	{
	    long sum = 0;
	...
	public static void main(String[] args) {
		...
		MinimumNumberOfPages minPageObject = new MinimumNumberOfPages();
		int m = 2;
		long l = minPageObject.findPages(arr, arr.length, m);
